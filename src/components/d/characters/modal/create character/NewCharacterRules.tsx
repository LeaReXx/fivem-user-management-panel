    ...
    <div>
      ...
      <div className="mt-4 bg-inside-box-bg-color p-2 rounded-md">
        <ul className="list-decimal space-y-2 list-inside">
          ...
          <li>
            از انتخاب اسم یا فامیل افراد مطرح، مشهور فیلم / سریال / انیمه / NP و
            ... پرهیز نمایید.
          </li>
          <li>در انتخاب ملیت کاراکتر دقت کنید.</li>
          <li>اگر در ثبت اطلاعات OOC به مشکل خوردید تیکت باز کنید.</li>
          <li>
            وظیفه‌ی ویرایش در اسم و فامیل تا قبل از تایید، به‌عهده‌ی کاربر می‌باشد،
            لطفا از باز کردن تیکت در دیسکورد پرهیز کنید.
          </li>
          <li>
