...
const ShopItems: React.FC = () => {
  return (
    <div className="order-3 col-span-12 bg-gradient-to-t from-secondary-box-background/90 to-main-box-background/90 backdrop-blur-[2px] h-[280px] rounded-lg p-4">
